...
import { solana, baseSepolia, sepolia, base } from '@particle-network/connectkit/chains';
...
if (!projectId || !clientKey || !appId) {
  ...
  console.warn('NEXT_PUBLIC_APP_ID=your_app_id');
  console.warn('Wallet connection will not work without these variables.');
}
...
'Segoe UI Symbol'`,
  ...
  walletConnectors: [
    evmWalletConnectors({
      ...
      // walletConnectProjectId: process.env.NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID, // Disabled to prevent connection errors
    }),
  ...
  chains: [baseSepolia, solana, sepolia, base],
});
